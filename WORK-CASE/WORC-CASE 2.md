...
**CLI (Command Line Interface) — Інтерфейс командного рядка (термінальний ввід).**

**GUI (Graphical User Interface) — Графічний інтерфейс користувача**

**Host OS — Хостова операційна система (основна ОС вашого ПК).**

**Guest OS — Гостьова операційна система (ОС, встановлена всередині гіпервізора).**

**Extension Pack — Пакет доповнень (для підтримки USB 2.0/3.0 та інших функцій).**
